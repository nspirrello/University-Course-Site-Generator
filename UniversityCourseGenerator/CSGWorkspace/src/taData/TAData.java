...
public class TAData  {
    ...
    public TAData(CSGApp initApp) {
        ...
        ArrayList<String> timeHeaders = props.getPropertyOptionsList(CSG.CSGProp.OFFICE_HOURS_TABLE_HEADERS);
        ArrayList<String> dowHeaders = props.getPropertyOptionsList(CSG.CSGProp.DAYS_OF_WEEK);
...
//        if (hour < startHour)
    ...
    private void initOfficeHours(int initStartHour, int initEndHour) {
        ...
        // STRUCTURE AS WE GO
        Workspace workspaceComponent = (Workspace)app.getWorkspaceComponent();
        workspaceComponent.getTaDataPane().reloadOfficeHoursGrid(this);
        
        workspaceComponent.getTaDataPane().getOfficeHour(true).getSelectionModel().select(startHour);
        workspaceComponent.getTaDataPane().getOfficeHour(false).getSelectionModel().select(endHour);
    }
    ...
    public void replaceTAName(String name, String newName){
        ...
        for(Pane p : workspace.getTaDataPane().getOfficeHoursGridTACellPanes().values()){
